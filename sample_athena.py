...
patient_csv_cur.save(record=patient_records, file_loc="data/sample_athena_patients.csv")
note_csv_cur.save(record=note_records, file_loc="data/sample_athena_notes.csv")
