...
patient_csv_cur.save(record=patient_records, file_loc="data/sample_mayo_patients.csv")
note_csv_cur.save(record=note_records, file_loc="data/sample_mayo_notes.csv")
