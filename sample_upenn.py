...
patient_csv_cur.save(records=patient_records, file_loc="data/sample_upenn_patients.csv")
note_csv_cur.save(records=note_records, file_loc="data/sample_uppen_notes.csv")
